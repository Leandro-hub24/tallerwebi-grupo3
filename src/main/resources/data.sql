...
INSERT INTO Usuario(id, username, email, password, rol, activo, rompecabezaNivel, versusNivel) VALUES(null,'Juan', 'test@unlam.edu.ar', 'test', 'ADMIN', true, 1, 1);
INSERT INTO Usuario(id, username,  email, password, rol, activo, rompecabezaNivel, versusNivel) VALUES(null,'Leandro', 'admin@example.com', '1234', 'ADMIN', true, 1, 1);
